...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{ns_10_2.pdf}
        \caption{CIFAR-10}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{ns_100_2.pdf}
        \caption{CIFAR-100}
    \end{subfigure}%
    \vspace{-3mm}
...
%    \centering
   \vspace{5mm}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{s_10_2.pdf}
        \caption{CIFAR-10}
    \end{subfigure}
    ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc. 
    %(or a blank line to force the subfigure onto a new line)
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{s_100_2.pdf}
        \caption{CIFAR-100}
    \end{subfigure}%
        \vspace{-3mm}
